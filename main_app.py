...
class MainApp:
    ...
    def show_dashboard(self):
        ...
        for i, (title, value, color) in enumerate(stats_data):
            ...
            stat_frame.grid(row=0, column=i, padx=15, sticky='nsew')
            
            ttk.Label(stat_frame, text=value, font=("Arial", 20, "bold"), 
    ...
    def show_servicios(self):
        ...
        ttk.Label(content_frame, text="🔧 Gestión de Servicios", 
                 font=("Arial", 20, "bold"), foreground="#9b59b6").pack(pady=20)
